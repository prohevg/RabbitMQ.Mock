...
{
    public class SendFrameContext : ISendFrameContext
    {
        public SendFrameContext(IAmqpFrameMethod frame, IAmqpFrameContentHeader header = null, LinkedList<IAmqpFrameContent> content = null)
        {
            Method = frame;
            Header = header;
            Content = content;
